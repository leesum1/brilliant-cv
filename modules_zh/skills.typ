...
#cvSkill(type: [芯片设计], info: [熟练掌握处理器设计、SOC 构建、FPGA 开发等设计技术，具备从 *RTL 设计、仿真到验证*的经验])
// #cvSkill(type: [嵌入式开发], info: [深入了解嵌入式系统开发流程，拥有 BSP 开发经验，熟悉 *SPI/I2C/UART 等接口协议*，具备从*底层硬件到系统软件*的开发能力])
#cvSkill(type: [嵌入式开发], info: [深入了解嵌入式系统开发流程，拥有 BSP 开发经验，熟悉，具备从*底层硬件到系统软件*的开发能力])
